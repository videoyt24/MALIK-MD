...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://iili.io/J1aDGON.md.jpg'
module.exports = {
  
  sessionName:  process.env.SESSION_ID ||  "session",
  botname:   process.env.BOT_NAME === undefined ? 'XHRISS-BOT' : process.env.BOT_NAME,
  ...
  packname:  process.env.PACK_INFO === undefined ? 'xhriss-Md' : process.env.PACK_INFO.split(";")[1],
